...
// QTI_BEGIN: 2023-12-11: Telephony: Preserve isNetworkIdentifiedEmergencyCall for Connection during handover.
...
// QTI_END: 2023-12-11: Telephony: Preserve isNetworkIdentifiedEmergencyCall for Connection during handover.
...
// QTI_BEGIN: 2024-06-03: Telephony: Set mTreatIsEmergencyCall to true when the call is an emergency call.
        if (isEmergency || tm.isEmergencyNumber(mOriginalConnection.getAddress())) {
// QTI_END: 2024-06-03: Telephony: Set mTreatIsEmergencyCall to true when the call is an emergency call.
